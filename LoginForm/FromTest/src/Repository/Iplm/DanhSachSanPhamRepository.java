...
public class DanhSachSanPhamRepository implements IDanhSachSanPhamRepository {
    ...
    public ArrayList<DanhSachSanPhamResponse> getAll() {
        String query = "SELECT dbo.SanPhamChiTiet.Id, dbo.SanPham.Ma, dbo.SanPham.Ten, dbo.SanPhamChiTiet.NamBH, dbo.SanPhamChiTiet.MoTa, dbo.SanPhamChiTiet.SoLuongTon, dbo.SanPhamChiTiet.GiaNhap, dbo.SanPhamChiTiet.GiaBan\n"
        ...
        try (Connection con = SQLServerConnection.getConnection(); PreparedStatement ps = con.prepareStatement(query);) {
            ...
            while (rs.next()) {
                DanhSachSanPhamResponse danhSachSanPhamResponse = new DanhSachSanPhamResponse(rs.getString(1), rs.getString(2), rs.getString(3), rs.getInt(4), rs.getString(5), rs.getInt(6), rs.getFloat(7), rs.getFloat(8));
